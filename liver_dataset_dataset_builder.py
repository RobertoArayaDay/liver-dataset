...
class Builder(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for liver_dataset dataset."""
    ...
    def _info(self) -> tfds.core.DatasetInfo:
        ...
        # TODO(liver_dataset): Specifies the tfds.core.DatasetInfo object
    ...
    def _generate_examples(self, path, patient):
        """Yields examples."""
        # TODO(liver_dataset): Yields (key, example) tuples from the dataset
